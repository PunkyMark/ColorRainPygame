...
homebg = [pygame.image.load('Home_red_2.png'), pygame.image.load('Home_green_2.png'), pygame.image.load('Home_yellow_2.png'),
...
while not gameExit:
    ...
    if rain_y >= rain_y_dis_pos and rain_x >= ball_x and rain_x < (ball_x + ball_width):
        if rain_color == blue:
            gameExit = False
            gameOver = False
        ...
        if rain_color != blue:
            if ball_y <= 300:
                ...
                gameExit = False
                homeScreen = False
            rain_y_dis = rain_y_dis - 49
            print(rain_y_dis)
            rain_y_dis_pos = rain_y_dis_pos - 50
            print(rain_y_dis_pos)
